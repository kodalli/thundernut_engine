...
pub fn package(
    ...
    switch (host.os.tag) {
        .windows => {
            ...
            const files_windows = &[_][]const u8{
                src_dir ++ "monitor.c",
                src_dir ++ "init.c",
                src_dir ++ "vulkan.c",
                src_dir ++ "input.c",
            ...
            const flags_windows = &[_][]const u8{
                "-D_GLFW_WIN32",
            };
            zglfw_c_cpp.addCSourceFiles(files_windows, flags_windows);
        },
        .macos => {
            ...
            const flags_macos = &[_][]const u8{
                "-D_GLFW_COCOA",
            };
            zglfw_c_cpp.addCSourceFiles(files_macos, flags_macos);
        },
        else => {
            // We assume Linux (X11)
            ...
            const flags_linux = &[_][]const u8{
                "-D_GLFW_X11",
            };
            zglfw_c_cpp.addCSourceFiles(files_linux, flags_linux);
        },
    }
